	...
	function obtenerTodos(arrayIds,venta_factura) {
		...
		if (pk_cliente!="") {
				...
				$.ajax({
					...
					type: 'POST',
					data:{pk_venta:<?php echo $_GET['pk_venta']; ?>,total:totalFinal,pk_usuario:<?php echo $_SESSION['pk_admin']; ?>,pk_cliente:pk_cliente,cantPago:cantPago,factura:venta_factura},
					cache: false,
					success: function(resultado){
