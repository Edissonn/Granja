	...
	<div class="banner1" id="home">
		<div class="center-container inner_agile">
			...
			<div class="top_header_agile_info_w3ls">
					...
					<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
						<div class="w3l_header_left">
							<ul>
								...
								<li><i class="fa fa-envelope-o" aria-hidden="true"></i> <a href="www.hotmail.com">liza_kovacks@hotmail.com</a></li>
							</ul>
						</div>
							...
							<nav class="menu menu--sebastian">
								<ul id="m_nav_list" class="m_nav menu__list">
									<li class="m_nav_item" id="m_nav_item_1">
										<a href="index.php" class="link link--kumya">
											<i class="fa fa-home" aria-hidden="true"></i><span data-letters="Inicio">Inicio</span>
										</a></li>
										<li class="m_nav_item active" id="moble_nav_item_3">
											<a href="sobre nosotros.php" class="link link--kumya">
												<i class="fa fa-info-circle" aria-hidden="true"></i>
												<span data-letters="Sobre nosotros">Sobre nosotros</span></a></li>
											<li class="m_nav_item" id="moble_nav_item_4">
												<a href="galeria.php" class="link link--kumya">
													<i class="fa fa-picture-o" aria-hidden="true"></i>
													<span data-letters="Galería">Galería</span></a>
												</li>
												...
												<li class="m_nav_item" id="moble_nav_item_6"> <a href="contacto.php" class="link link--kumya"><i class="fa fa-envelope-o" aria-hidden="true"></i><span data-letters="Contact">Contacto</span></a></li>
								...
								<div class="signin-form profile">
									...
									<div class="login-form">
										<form action="#" method="post">
											<input type="email" name="nom_usuario" placeholder="Nombre usuario" required="">
									...
									<p><a href="#" data-toggle="modal" data-target="#myModal3">olvidaste tu contraseña?</a></p>
								</div>
							</div>
						</div>
					</div>
								...
								<div class="signin-form profile">
									...
									<div class="login-form">
										<form action="#" method="post">
											...
											<input type="password" name="contraseña" placeholder="contraseña" required="">
											<input type="password" name="contraseña" placeholder="Confirm Password" required="">
											<input type="submit" value="Regístrate">
										</form>
									</div>
									<p><a href="#"> Al hacer clic en Registrarse, acepto sus términos</a></p>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="about">
					<div class="container">
						<h2 class="title-w3-agileits inner">Sobre nosotros</h2>
						<p class="quia">Detail description about Farm</p>
						...
						<div class="agile_about_grids">
							<div class="col-md-6 agile_about_grid_left">
								...
								<div class="clearfix"> </div>
								<img class="agile_about_grid_left_img img-responsive" src="images/banner1.jpg" alt=" " />
							</div>
							<div class="col-md-6 agile_about_grid_right">
								...
								<p>Et harum quidem rerum facilis est et expedita <span>distinctio</span>. Nam libero tempore, cum soluta nobis est eligendi
									...
									<div class="more wthree_more1 ">
										<a href="single.html" class="hvr-shutter-in-vertical"> Leer mas <span class="glyphicon glyphicon-arrow-right"></span></a>
									</div>
								</div>
								<div class="clearfix"> </div>
							</div>
					...
					<div class="about-bottom">
						<div class="container">
							<div class="w3l_about_bottom_grids">
								<div class="col-md-6 w3l_about_bottom_grid_left">
									<h3>cupidatat non proident, sunt in culpa qui officia</h3>
									...
									<div class="col-md-6 w3l_about_bottom_grid_right">
										<div class='bar_group'>
											<div class='bar_group__bar thin elastic' label='Max Imports And exports' value='230'></div>
											<div class='bar_group__bar thin elastic' label='Free of charge' value='130'></div>
											<div class='bar_group__bar thin elastic' label='Number of dealers' value='160'></div>
											<div class='bar_group__bar thin elastic' label='Cows' value='340'></div>
											<div class='bar_group__bar thin elastic' label='Clients' value='290'></div>
										</div>
									</div>
									<div class="clearfix"> </div>
								</div>
						...
						<div class="services">
							<div class="container">
								<h3 class="title-w3-agileits two">Some More Services</h3>
								<p class="quia">From our Farm</p>
								...
								<div class="w3l_services_grids">
									<div class="col-md-3 w3l_services_grid">
										<div class="w3l_services_grid1">
											...
											<h4><a href="single.html">Our Dairy Farm</a></h4>
									...
									<div class="col-md-3 w3l_services_grid">
										<div class="w3l_services_grid1">
											...
											<h4><a href="single.html">Meet Our Cows</a></h4>
											<p>Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil impedit.</p>
										</div>
									</div>
									<div class="col-md-3 w3l_services_grid">
										<div class="w3l_services_grid1">
											...
											<h4><a href="single.html">Organic Food</a></h4>
											<p>Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil impedit.</p>
										</div>
									</div>
									<div class="col-md-3 w3l_services_grid">
										<div class="w3l_services_grid1">
											...
											<h4><a href="single.html">Fresh Butter</a></h4>
											<p>Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil impedit.</p>
										</div>
									</div>
									<div class="clearfix"> </div>
								...
								<div class="w3l_services_grids">
									<div class="col-md-3 w3l_services_grid">
										<div class="w3l_services_grid1">
											...
											<h4><a href="single.html">Milk</a></h4>
											<p>Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil impedit.</p>
										</div>
									</div>
									<div class="col-md-3 w3l_services_grid">
										<div class="w3l_services_grid1">
											<span class="fa fa-cube" aria-hidden="true"></span>
											<h4><a href="single.html">Cheese</a></h4>
											<p>Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil impedit.</p>
										</div>
									</div>
									<div class="col-md-3 w3l_services_grid">
										<div class="w3l_services_grid1">
											...
											<h4><a href="single.html">Butter</a></h4>
											<p>Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil impedit.</p>
										</div>
									</div>
									<div class="col-md-3 w3l_services_grid">
						...
						<div class="special-services">
							<div class="container">
								<h3 class="title-w3-agileits inner">Special Services</h3>
								<p class="quia">From our Farm</p>
								...
								<div class="agileinfo_copy_right">
									<div class="container">
										<div class="agileinfo_copy_right_left">
											<p>© 2017 Farm. All rights reserved | Design by <a href="http://w3layouts.com/">W3layouts</a></p>
										</div>
